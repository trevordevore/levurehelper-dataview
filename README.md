...
3. Using the property inspector your application stack, add the **dataview_behavior.livecodescript** stack file to the `mainstacks` property of your application stack.
